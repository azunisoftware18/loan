...
const ProfitLossBalances = () => {
  ...
  const profitLossData = {
    ...
    cogs: [
      { id: 4, name: 'Cost of Goods Sold', amount: 900000, growth: 10.2 },
    ],
    expenses: [
  ...
  const balanceSheetData = {
    ...
    assets: {
      ...
      fixedAssets: [
        ...
        { id: 6, name: 'Less: Accumulated Depreciation', amount: 500000, isNegative: true },
    ...
    <div className="space-y-6">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <div className="flex items-center gap-1 mt-2">
                <TrendingUp className="h-4 w-4 text-green-500" />
                <span className="text-xs text-green-600 font-medium">+8.7% from last month</span>
              </div>
            </div>
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <div className="flex items-center gap-1 mt-2">
                <TrendingUp className="h-4 w-4 text-green-500" />
                <span className="text-xs text-green-600 font-medium">+15.2% from last month</span>
              </div>
            </div>
      ...
      <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
        <div className="p-6 border-b border-gray-200">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-600">For the period ending 31 Mar 2024</p>
            </div>
        ...
        <div className="border-b border-gray-200">
          ...
          >
            <div className="flex items-center gap-3">
              <ChevronRight className={`h-4 w-4 transition-transform ${expandedSections.revenue ? 'rotate-90' : ''}`} />
        ...
        <div className="border-b border-gray-200 px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              ...
              <span className="font-medium text-red-600">{formatCurrency(profitLossData.cogs[0].amount)}</span>
            </div>
          </div>
        </div>
        ...
        <div className="border-b border-gray-200">
          ...
          >
            <div className="flex items-center gap-3">
              <ChevronRight className={`h-4 w-4 transition-transform ${expandedSections.expenses ? 'rotate-90' : ''}`} />
              <h4 className="font-semibold text-gray-900">Operating Expenses</h4>
            </div>
            ...
            <div className="px-6 pb-4">
              {profitLossData.expenses.map((item) => (
                <div key={item.id} className="flex items-center justify-between py-2">
                  ...
                  <div className="flex items-center gap-4">
                    <span className={`text-sm ${item.growth >= 0 ? 'text-red-600' : 'text-green-600'}`}>
                      {item.growth >= 0 ? '+' : ''}{item.growth}%
                    </span>
                    <span className="font-medium">{formatCurrency(item.amount)}</span>
                  </div>
        ...
        <div className="px-6 py-6 bg-blue-50">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <h4 className="text-lg font-bold text-gray-900">Net Profit / (Loss)</h4>
            </div>
          ...
          <div className="mt-2 text-sm text-gray-600">
            Profit Margin: {formatPercentage(profitLossData.summary.profitMargin)}
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="text-center p-4 border border-gray-200 rounded-lg">
            <div className="text-2xl font-bold text-gray-900">1.85x</div>
          ...
          <div className="text-center p-4 border border-gray-200 rounded-lg">
            ...
            <div className="text-xs text-yellow-600 font-medium mt-1">Average</div>
          </div>
          <div className="text-center p-4 border border-gray-200 rounded-lg">
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-sm text-gray-600">As of {balanceSheetData.currentDate}</p>
          </div>
          <div className="flex items-center gap-2">
            <button className="px-3 py-1.5 text-sm border border-gray-300 rounded-lg hover:bg-gray-50">
              Previous Period
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <div className="mb-6">
              ...
              >
                <div className="flex items-center gap-2">
                  <ChevronRight className={`h-4 w-4 transition-transform ${expandedSections.assets ? 'rotate-90' : ''}`} />
                  <span className="font-medium text-gray-700">Current Assets</span>
                </div>
                <span className="font-medium">
                  {formatCurrency(balanceSheetData.assets.currentAssets.reduce((sum, asset) => sum + asset.amount, 0))}
                </span>
              </button>
            ...
            <div>
              <div className="flex items-center justify-between py-2 px-2">
                ...
                <span className="font-medium">
                  {formatCurrency(balanceSheetData.assets.fixedAssets.reduce((sum, asset) => 
                    sum + (asset.isNegative ? -asset.amount : asset.amount), 0))}
                </span>
              </div>
              <div className="pl-6 space-y-2">
                {balanceSheetData.assets.fixedAssets.map((asset) => (
                  <div key={asset.id} className="flex items-center justify-between py-1">
                    <div className="flex items-center gap-2">
                      <div className="w-1.5 h-1.5 bg-blue-500 rounded-full"></div>
                      <span className={`${asset.isNegative ? 'text-red-600' : 'text-gray-700'}`}>
                        {asset.name}
                      </span>
                    </div>
                    <span className={`font-medium ${asset.isNegative ? 'text-red-600' : ''}`}>
                      {asset.isNegative ? '-' : ''}{formatCurrency(asset.amount)}
                    </span>
                  </div>
                ))}
              </div>
            ...
            <div className="mb-8">
              ...
              <div>
                <div className="flex items-center justify-between py-2 px-2">
                  ...
                  <span className="font-medium">
                    {formatCurrency(balanceSheetData.liabilities.currentLiabilities.reduce((sum, liability) => sum + liability.amount, 0))}
                  </span>
                </div>
                <div className="pl-6 space-y-2">
                  {balanceSheetData.liabilities.currentLiabilities.map((liability) => (
                    <div key={liability.id} className="flex items-center justify-between py-1">
                      <div className="flex items-center gap-2">
              ...
              <div className="mt-4">
                <div className="flex items-center justify-between py-2 px-2">
                  <span className="font-medium text-gray-700">Long-term Liabilities</span>
                  <span className="font-medium">
                    {formatCurrency(balanceSheetData.liabilities.longTermLiabilities.reduce((sum, liability) => sum + liability.amount, 0))}
                  </span>
                </div>
                <div className="pl-6 space-y-2">
        ...
        <div className="mt-8 pt-6 border-t border-gray-200">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="text-center p-4 bg-blue-50 rounded-lg">
              ...
              <div className="text-sm font-medium text-gray-700">Total Assets</div>
            </div>
            <div className="text-center p-4 bg-emerald-50 rounded-lg">
              <div className="text-2xl font-bold text-emerald-600">
                {formatCurrency(balanceSheetData.totalLiabilitiesAndEquity)}
              </div>
              <div className="text-sm font-medium text-gray-700">Total Liabilities & Equity</div>
            </div>
          </div>
          <div className="mt-4 text-center">
            <div className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium ${
              Math.abs(balanceSheetData.assets.totalAssets - balanceSheetData.totalLiabilitiesAndEquity) < 1000
                ? 'bg-green-100 text-green-800'
                : 'bg-red-100 text-red-800'
            }`}>
              {Math.abs(balanceSheetData.assets.totalAssets - balanceSheetData.totalLiabilitiesAndEquity) < 1000
                ? <><CheckCircle className="h-4 w-4 mr-1" /> Balance Sheet Matches</>
                : <><AlertCircle className="h-4 w-4 mr-1" /> Balance Sheet Does Not Match</>
              }
            </div>
          </div>
        </div>
  ...
  const renderBranchwise = () => (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h3 className="text-lg font-semibold text-gray-900">Branch-wise Financial Comparison</h3>
            <p className="text-sm text-gray-600">Performance analysis across all branches</p>
          </div>
          <div className="flex items-center gap-2">
            <select 
          ...
          <table className="min-w-full divide-y divide-gray-200">
            <thead>
              <tr className="bg-gray-50">
                ...
                <th className="px-4 py-3 text-left text-xs font-semibold text-gray-700 uppercase">Net Profit</th>
                <th className="px-4 py-3 text-left text-xs font-semibold text-gray-700 uppercase">Profit Margin</th>
            ...
            <tbody className="divide-y divide-gray-200">
              {branchComparisonData.map((branch, index) => (
                <tr key={index} className="hover:bg-gray-50">
                  ...
                  <td className="px-4 py-3 font-medium">{formatCurrency(branch.revenue)}</td>
                  <td className="px-4 py-3 font-medium text-red-600">{formatCurrency(branch.expenses)}</td>
                  <td className="px-4 py-3 font-bold text-green-600">{formatCurrency(branch.netProfit)}</td>
                  <td className="px-4 py-3">
                    <span className={`font-medium ${
                      branch.profitMargin > 15 ? 'text-green-600' :
                      branch.profitMargin > 10 ? 'text-yellow-600' : 'text-red-600'
                    }`}>
                  ...
                  <td className="px-4 py-3">
                    <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
                      ...
                      branch.performance === 'satisfactory' ? 'bg-yellow-100 text-yellow-800' :
                      'bg-gray-100 text-gray-800'
                    }`}>
                      {branch.performance.charAt(0).toUpperCase() + branch.performance.slice(1)}
                    </span>
                  </td>
                </tr>
              ))}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white rounded-xl border border-gray-200 p-6">
          <h4 className="font-semibold text-gray-900 mb-4">Revenue Distribution by Branch</h4>
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6">
          <h4 className="font-semibold text-gray-900 mb-4">Profit Trend Analysis</h4>
          <div className="h-64 flex items-center justify-center bg-gray-50 rounded-lg">
            <div className="text-center text-gray-500">
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4 md:p-6">
      ...
      <div className="mb-6">
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-4">
          <div>
            ...
            <p className="text-gray-600 mt-1">Profit & Loss, Balance Sheet, and Branch-wise Analysis</p>
          </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
          <div className="bg-white rounded-lg border border-gray-200 p-3">
            ...
            <div className="text-lg font-bold text-gray-900 mt-1">{formatCurrency(2450000)}</div>
          </div>
          <div className="bg-white rounded-lg border border-gray-200 p-3">
            <div className="flex items-center gap-2">
            ...
            <div className="text-lg font-bold text-gray-900 mt-1">{formatCurrency(805000)}</div>
          </div>
          <div className="bg-white rounded-lg border border-gray-200 p-3">
            <div className="flex items-center gap-2">
            ...
            <div className="text-lg font-bold text-gray-900 mt-1">{formatCurrency(4025000)}</div>
          </div>
          <div className="bg-white rounded-lg border border-gray-200 p-3">
            <div className="flex items-center gap-2">
              <CreditCard className="h-4 w-4 text-orange-600" />
              <span className="text-sm font-medium text-gray-700">Active Branches</span>
            </div>
            <div className="text-lg font-bold text-gray-900 mt-1">3</div>
          </div>
        </div>
      </div>
      ...
      <div className="mt-6 text-sm text-gray-500">
        <p>Note: All figures are in Indian Rupees (₹). Reports are generated based on accounting period settings.</p>
